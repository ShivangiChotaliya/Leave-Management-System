                                                    ...
                                                    <div class="row">
                                                        <div class="col m6">
                                                            <div class="row">
                                                                <div class="input-field col  s12">
                                                                    <label for="empcode">Employee Code(Must be
                                                                        unique)</label>
                                                                    <input name="eid" id="empcode" type="text"
                                                                        autocomplete="off" required>
                                                                    <span id="empid-availability"
                                                                        style="font-size:12px;"></span>
                                                                </div>
                                                                <div class="input-field col m6 s12">
                                                                    <label for="firstName">Employee's name</label>
                                                                    <input id="firstName" name="ename" type="text"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="input-field col m6 s12">
                                                                    <select name="department" autocomplete="off">
                                                                        ...
                                                                        <% try{ Class.forName("com.mysql.jdbc.Driver");
                                                                            Connection
                                                                            con=DriverManager.getConnection("jdbc:mysql://localhost/db_leave","root","");
                                                                            Statement st=con.createStatement(); String
                                                                            query="select *from department" ; ResultSet
                                                                ...
                                                                <div class="input-field col s12">
                                                                    <label for="confirm">Confirm
                                                                        password</label>
                                                                    <input id="confirm" name="confirmpassword"
                                                        ...
                                                        <div class="col m6">
                                                            <div class="row">
                                                                ...
                                                                <div class="input-field col s12">
                                                                    <input type="submit" name="Register" id="add"
